$(document).ready(function() {
  ...
  var jiraHome =
    localStorage.getItem("logwork-jira-home") || "https://jira.elsevier.com";
  input("jiraHome").val(jiraHome);
...
function request(startDate, endDate) {
  ...
  var jiraHome = input("jiraHome").val();
  localStorage.setItem("logwork-jira-home", jiraHome);

  var targetUser = input("targetUser").val();
  localStorage.setItem("logwork-user", targetUser);
